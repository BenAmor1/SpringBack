...
public class CategoriesDTO implements Serializable {
	...
	public CategoriesDTO(long id, String nom, int qt, Timestamp datecreation, Timestamp datemmodif,
	...
	public CategoriesDTO(String nom, int qt, Timestamp datecreation, Timestamp datemmodif, List<Produits> listProduits) {
		super();
		this.nom = nom;
		this.qt = qt;
		this.datecreation = datecreation;
	...
	public CategoriesDTO(String nom, int qt, Timestamp datecreation, Timestamp datemmodif) {
		super();
		this.nom = nom;
		this.qt = qt;
		this.datecreation = datecreation;
	...
	public CategoriesDTO(String nom) {
		super();
		this.nom = nom;
	}
	public CategoriesDTO(String nom, int qt) {
		super();
		this.nom = nom;
		this.qt = qt;
	}
	public CategoriesDTO(String nom, Timestamp datecreation) {
		super();
		this.nom = nom;
		this.datecreation = datecreation;
	}
	public CategoriesDTO(String nom, int qt, Timestamp datemmodif) {
		super();
		this.nom = nom;
		this.qt = qt;
		this.datemmodif = datemmodif;
