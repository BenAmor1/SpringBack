...
public class ProduitsDTO implements Serializable {
	...
	public ProduitsDTO(long id, String nom, int qt, boolean disponible, Timestamp datecreation, Timestamp datemodif,
	...
	public ProduitsDTO(String nom, int qt, boolean disponible, Timestamp datecreation, Timestamp datemodif,
			Categories categories) {
		super();
		this.nom = nom;
		this.qt = qt;
